  ...
  <div class="container-scroller">
    ...
    <nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
      <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
        <a class="navbar-brand brand-logo mr-5" href="index.html"><img src="{{ asset('/') }}assets/images/brand (1).png" class="mr-2" alt="logo"/></a>
        <a class="navbar-brand brand-logo-mini" href="index.html"><img src="{{ asset('/') }}assets/images/brand (1).png" alt="logo"/></a>
      </div>
        ...
        <nav class="sidebar sidebar-offcanvas" id="sidebar">
            <ul class="nav">
                <li class="nav-item">
                    ...
                    {{-- <liclass="menu-item  {{ \Route::currentRouteName() == 'home' || \Route::currentRouteName() == 'dashboard' ? 'active' : '' }}">
      ...
      <!-- partial -->
        <div class="main-panel">
            ...
            <div class="d-sm-flex justify-content-center justify-content-sm-between">
                <span class="text-muted text-center text-sm-left d-block d-sm-inline-block">Copyright © 2021.  Odisha ITMS . All rights reserved.</span>
